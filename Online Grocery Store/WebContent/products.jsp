...
<body bgcolor="#BCC167">
	  ...
	  <th width=""  class="text-center">Product cost</th>
	  </tr></thead>
	  <%
try{
...
ps = con.prepareStatement("select product.product_id,product.pname,productpricing.cost from product,productpricing where product.product_id=productpricing.product_id");
 
rs = ps.executeQuery();
while(rs.next()){
	id1=rs.getString("product.product_id");
	name=rs.getString("product.pname");
	prodsize=rs.getString("productpricing.cost");
%>
